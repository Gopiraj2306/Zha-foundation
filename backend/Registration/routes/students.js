...
router.post('/', isAuthenticated, isSuperAdmin, studentController.createStudent);
...
router.post('/bulk-upload', isAuthenticated, isSuperAdmin, studentController.bulkUploadStudents);
